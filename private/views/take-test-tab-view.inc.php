<?php $percentage = $this->get_answer_percentage($questions, $save_answers) ?>
...
<?php if (isset($questions) && is_array($questions)) : ?>
    ...
    <form method="post">
        ...
        <?php foreach ($questions as $question) : $num++ ?>
            ...
            <?php
            $myanswer = $this->get_answer($save_answers, $question->id);
            ?>
        ...
        <?php endforeach; ?>
        <center>
            <button class="btn btn-primary">Save Your Answers</button>
        </center>
    </form>
<?php endif; ?>