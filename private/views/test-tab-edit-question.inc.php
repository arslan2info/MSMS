    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <?php if (isset($_GET["type"]) && $_GET["type"] == "objective") : ?>
            <div class="input-group mb-3">
                ...
                <input type="text" value="<?= get_var('correct_answer', $question->correct_answer) ?>" name="correct_answer" class="form-control" id="inputGroupFile01" placeholder="Enter the correct answer here">
            </div>
        <?php endif; ?>
                        ...
                        <?php foreach ($choices as $letter => $answer): ?>
                            <li class="list-group-item">
                                ...
                                <label style="cursor: pointer;">
                                    <input <?= $letter == $question->correct_answer ? "checked" : ''; ?> type="radio" value="<?= $letter ?>" name="correct_answer"> Correct Answer</label>
                            </li>
                            <?php $num++ ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
